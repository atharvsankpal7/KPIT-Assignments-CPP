...
{
    int dailySalary = EmployeeSalary / 30;
    int reimbursementDays = PaidLeavesCount - PaidLeavesClaimed;
    return dailySalary * reimbursementDays;
}
...
{
    return (int)GetEmployeeSalary() * GetProjectsCompletedCount();
}