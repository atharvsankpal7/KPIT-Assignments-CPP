...
CxxTest::StaticSuiteDescription suiteDescription_SampleTestSuite( "test.h", 54, "SampleTestSuite", suite_SampleTestSuite, Tests_SampleTestSuite );

static class TestDescription_suite_SampleTestSuite_testOne : public CxxTest::RealTestDescription {
public:
 TestDescription_suite_SampleTestSuite_testOne() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 59, "testOne" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testTwo() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 67, "testTwo" ) {}
...
public:
 TestDescription_suite_SampleTestSuite_testThree() : CxxTest::RealTestDescription( Tests_SampleTestSuite, suiteDescription_SampleTestSuite, 75, "testThree" ) {}
